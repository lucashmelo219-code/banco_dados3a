...
<body>
  ...
  ?>
  <!-- existem 2 metodos de envio de formulario, get e post , aqui usamos o post -->
  <main class="container" style="margin-top: 80px;">
      ...
      <form action="db-aluno.php" method="post" class="row g3 mt-3 p-3">
        ...
        <div class="row g-3">
          ...
          <div class="col-6">
            ...
            <input type="text" class="form-control" id="logradouro" name="logradouro" maxlength="100"
          ...
          <div class="col-md-5  ">
            ...
            <input type="text" class="form-control" id="cep" name="cep" maxlength="9" placeholder="00000-000"
              value="<?= $aluno->cep ?? null; ?>" data-mascara="00000-000">
          </div>
          ...
          <div class="col-12">
            ...
            <textarea class="form-control" id="objetivo" name="objetivo"
              rows="4"><?= $aluno->objetivo ?? null; ?></textarea>
          </div>
    ...
    <div class="col-12 mt-3">
      ...
      <button type="submit" class="btn btn-primary" name="btnGravar" id="btnGravar"> Enviar </button>
    </div>
